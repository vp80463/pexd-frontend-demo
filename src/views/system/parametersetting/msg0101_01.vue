...
const gridDB = gridDBApi.data;
const viy2Grid_18ZDtContentsEditRender = computed(() => {
  return {
    enabled: false,
  };
});
const viy2Grid_18ZDtDateEditRender = computed(() => {
  return {
    enabled: false,
    attrs: {
      textAlign: 'center',
...
const viy2Grid_18ZDtStatueEditRender = computed(() => {
  return {
    enabled: false,
  };
});
...
<template>
  <VueForm ref="form" v-loading="lockScreen" :model="formData">
    ...
    <VueForm
      ...
      :model="panelsData"
    >
      <VuePanel id="histPanel" ref="histPanel" v-model="historyPanelModel" title="Detail">
        <template #header>
        ...
        <VueTable id="viy2Grid_18ZDt" ref="viy2Grid_18ZDt" :data="gridDB" :edit-config="viy2Grid_18ZDtEditConfig">
          <VueRow
            id="viy2Row_18ZEg"
            ref="viy2Row_18ZEg"
          >
          ...
          />
          <VueInputColumn
            :edit-render="viy2Grid_18ZDtContentsEditRender"
            field="contents"
            title="Contents"
            width="300px"
          />
          <VueDateTimeColumn
            :edit-render="viy2Grid_18ZDtDateEditRender"
            field="date"
            align="center"
            title="Date"
            width="100px"
          />
          <VueInputColumn
            :edit-render="viy2Grid_18ZDtStatueEditRender"
            field="statue"
            title="Statue"
            width="100px"
          />
