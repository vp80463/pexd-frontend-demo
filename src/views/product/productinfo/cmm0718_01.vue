  ...
  localData: [
    {
      modelCd: 'B4U300010A',
      modelNm: 'FreeGo-B4U1',
      localModelCd: 'FRE-B4U1',
      type: 'FREEGO - B4U1',
    },
  ],
});
const jobDs = jobDsApi.data;
const viy2Grid_18ZDtModelCdEditRender = computed(() => {
  return {
    enabled: false,
  };
});
const viy2Grid_18ZDtModelNmEditRender = computed(() => {
  return {
    enabled: false,
  };
});
const viy2Grid_18ZDtLocalModelCdEditRender = computed(() => {
  return {
    enabled: false,
  };
});
const viy2Grid_18ZDtTypeEditRender = computed(() => {
  return {
    enabled: true,
  };
});
...
<template>
  <VueForm ref="form" v-loading="lockScreen" :model="formData">
    ...
    <VueForm
      ...
      :model="panelsData"
    >
      <VuePanel id="condition" ref="condition" v-model="conditionPanelModel" title="Condition">
        <VueForm
          id="conditionForm"
          ref="conditionForm"
          label-width="115px"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <VueInput
                  id="viy2InputBox_5mFG92"
                  ref="viy2InputBox_5mFG92"
      ...
      <VuePanel id="detail" ref="detail" v-model="historyPanelModel" title="Detail">
        <template #header>
          <div style="width: 300px">
            ...
            >
              <VueCol
                ...
                :md="{ span: 24 }"
              >
                <VueButton id="viy2Button_1KgcVM" ref="viy2Button_1KgcVM" icon-position="left">
                  Import
                </VueButton>
              </VueCol>
            </VueRow>
        ...
        <VueTable id="viy2Grid_18ZDt" ref="viy2Grid_18ZDt" :data="jobDs" :edit-config="viy2Grid_18ZDtEditConfig">
          <VueRow
            id="viy2Row_18ZEg"
            ref="viy2Row_18ZEg"
          >
          ...
          />
          <VueInputColumn
            :edit-render="viy2Grid_18ZDtModelCdEditRender"
            field="modelCd"
            title="Model Code"
            width="120px"
          />
          <VueInputColumn
            :edit-render="viy2Grid_18ZDtModelNmEditRender"
            field="modelNm"
            title="Model Name"
            width="175px"
          />
          <VueInputColumn
            :edit-render="viy2Grid_18ZDtLocalModelCdEditRender"
            field="localModelCd"
            title="Local Model Code"
            width="130px"
          />
          <VueInputColumn
            :edit-render="viy2Grid_18ZDtTypeEditRender"
            field="type"
            title="Type"
            width="120px"
          />
