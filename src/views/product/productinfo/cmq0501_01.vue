    ...
    <VuePanel id="viy2Panel_2rs6nZ" ref="viy2Panel_2rs6nZ" :collapse="true" title="基本情報">
      ...
      >
        ...
        >
          ...
          >
            <VueInput
              id="viy2InputBox_9taIXy"
              ref="viy2InputBox_9taIXy"
        ...
        >
          ...
          >
            <VueInput
              id="viy2InputBox_9tnBLm"
              ref="viy2InputBox_9tnBLm"
              v-model="formData.makerProductCd"
              :readonly="true"
              class="no-border"
            />
        ...
        >
          ...
          >
            <VueInput
              id="viy2InputBox_9th1tY"
              ref="viy2InputBox_9th1tY"
          ...
          >
            <VueInput
              id="viy2InputBox_9tom6q"
              ref="viy2InputBox_9tom6q"
              v-model="formData.makerProductCd"
              :readonly="true"
              class="no-border"
            />
