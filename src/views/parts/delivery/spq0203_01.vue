...
const gridDsApi = useApi({
  url: '/parts/spq0203/getInvoiceList.json',
  method: 'post',
  data: () => {
  ...
  onSuccess: (data) => {
    const tableDataList = data.content;
    ...
    >
      ...
      >
        <VuePanel id="viy2Panel_2Yg0N1" ref="viy2Panel_2Yg0N1" title="明細情報" height="100%">
          ...
          <VueTable id="grid" ref="grid" header-align="center" :show-footer="true" height="99%" :data="gridDs.content" :edit-config="gridEditConfig" :mouse-config="gridMouseConfig">
            <VueRow
              id="viy2Row_soVPC"
              ref="viy2Row_soVPC"
