    ...
    >
      ...
      >
        <VuePanel id="viy2Panel_30obz1" ref="viy2Panel_30obz1" height="100%" title="明細情報">
          ...
          <VueTable id="grid" ref="grid" header-align="center" :show-footer="true" height="99%" :data="gridDs.content" :edit-config="gridEditConfig" :mouse-config="gridMouseConfig" @cell-click="gridCellClick" @cell-dblclick="gridCellDblclick">
            <VueRow
              id="viy2Row_soVPC"
              ref="viy2Row_soVPC"
