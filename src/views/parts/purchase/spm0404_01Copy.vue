<script setup>
import { IconArrowDownBold, IconArrowLeftBold, IconDelete, IconDocument, IconRefreshRight, useLockScreen } from 'viy-ui';
...
const queryFormData = reactive({
  dateFrom: '', dateTo: '', poNo: '', salesOrderNo: '', type: '', status: ['発注中'], datafieldviy2CheckBox_pSMMd: false,
});
    ...
    >
      ...
      >
        ...
        <VuePanel id="viy2Panel_1hAuy" ref="viy2Panel_1hAuy" height="100%" title="明細情報">
          ...
          <VueTable id="grid" ref="grid" header-align="center" height="auto" :data="gridDs.content" :edit-config="gridEditConfig" :mouse-config="gridMouseConfig" @cell-dblclick="gridCellDblclick">
            <VueRow
              id="viy2Row_soVPC"
              ref="viy2Row_soVPC"
