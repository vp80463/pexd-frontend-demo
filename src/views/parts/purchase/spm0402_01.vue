...
const queryFormData = reactive({
  pointId: '', part: '', largeGroupId: '', costUsage: '',
});
  ...
  <VueForm ref="form" v-loading="lockScreen" :model="formData">
    ...
    >
      <VueFlex
        ...
        grow="1"
      >
        <VuePanel id="viy2Panel_14XQS" ref="viy2Panel_14XQS" title="検索条件" height="auto">
          <template #header>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <VueSelect
                    id="viy2Select_3zKeqC"
                    ref="viy2Select_3zKeqC"
                    v-model="queryFormData.costUsage"
                    :style="{ width: '200px' }"
                    :collapse-tags="true"
                    :clearable="true"
                    :collapse-tags-tooltip="true"
        ...
        <VuePanel id="viy2Panel_QGbH1" ref="viy2Panel_QGbH1" title="明細情報" height="100%">
          <template #header>
