...
const orderFormData = reactive({
  poNo: 'P2410000015', orderType: '', supplierOrderNo: '', orderStatus: '', orderDate: '',
});
...
onMounted(() => {
  orderFormData.poNo = 'P2410000015';
  orderFormData.orderType = 'RO';
  orderFormData.supplierOrderNo = 'S2410000056';
  orderFormData.orderStatus = '発注中';
  orderFormData.orderDate = '20241015';
});
