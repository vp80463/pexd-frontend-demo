...
const headerGridDsApi = useApi({
  method: 'post',
  localData: [
    { returnInvoiceNo: 'RINV20240101', returnDate: '20241001', reason: '1', invoiceNo: 'INV20240101', customerCd: '1', customerNm: 'テスト販売店', returnAmt: 1000 },
  ],
}, {
  ...
  <VueForm ref="form" v-loading="lockScreen" :model="formData">
    ...
    >
      <detailPagePage
        ...
        @select="callBackSpm020203"
        @close="closeSpm020203"
      />
    </VueAside>
  </VueForm>
</template>
