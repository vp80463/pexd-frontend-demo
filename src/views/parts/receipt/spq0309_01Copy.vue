...
<template>
  <VueForm ref="form" v-loading="lockScreen" :model="formData">
    <VueFlex
      ...
      class="full-height"
    >
      <VuePanel id="viy2Panel_2rs6nZ" ref="viy2Panel_2rs6nZ" title="検索条件">
        <template #header>
      ...
      <VueFlex
        ...
        grow="1"
      >
        <VuePanel id="viy2Panel_wZlWr" ref="viy2Panel_wZlWr" title="明細情報" height="100%">
          <template #header>
          ...
          <VueTable id="grid" ref="grid" height="auto" :show-footer="true" :data="gridDs.tableDataList" :edit-rules="gridRules" :edit-config="gridEditConfig" :mouse-config="gridMouseConfig">
            <VueRow
              id="viy2Row_7yiZLF"
              ref="viy2Row_7yiZLF"
