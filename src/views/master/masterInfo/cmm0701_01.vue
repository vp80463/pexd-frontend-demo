...
const viy2Form_MFuoeData = reactive({
  orgCd: '01234', orgAbbr: '特金製造', attribute: '販売店', orgRequestCd: '01234', regularRank: '05', shipflag: 'する', stopFlag: [], orgNm: '特金製造株式会社', orgNm: '特金製造', proDpCd: '5001', pcCd: '10011', resscutFlag: '', status: '有効',
});
