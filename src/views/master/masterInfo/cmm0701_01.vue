...
const queryFormData = reactive({
  shop: '', orgnizationAbbr: '', rank: '', stopshipflag: 'する', activeStatus: '有効',
});
...
const viy2Radio_2wODscOpts = reactive([
  { value: '有効', label: '有効' },
  { value: '無効', label: '無効' },
]);
...
<template>
  <VueForm ref="form" v-loading="lockScreen" :model="formData">
        ...
        <VuePanel id="viy2Panel_GvVgb" ref="viy2Panel_GvVgb" title="検索条件">
          ...
          >
            ...
            >
              ...
              <VueFormItem
                label="漢字略称"
                prop="orgnizationAbbr"
              >
                <VueInput
                  id="orgnizationAbbr"
                  ref="orgnizationAbbr"
                  v-model="queryFormData.orgnizationAbbr"
                />
              </VueFormItem>
              <VueFormItem
                label="純掛掛率ランク"
              ...
              >
                ...
                >
                  <VueRadioButton
                    v-for="option in viy2Radio_2wODscOpts"
                    :key="option.value"
                    :label="option.value"
                  >
                    {{ option.label }}
    ...
    >
      ...
      >
        <VuePanel id="viy2Panel_MFrbq" ref="viy2Panel_MFrbq" title="販売店情報">
          <VueRow
            id="viy2Row_MFE8R"
            ref="viy2Row_MFE8R"
          >
