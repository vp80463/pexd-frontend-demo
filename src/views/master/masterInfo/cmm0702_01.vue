...
const viy2Panel_GxIim = ref();
const viy2Button_ZvPFV = ref();
const grid = ref();
const aside001 = ref();
const viy2Row_TBVFW = ref();
const viy2Row_TCZrB = ref();
const viy2Button_ZKCsn = ref();
...
const viy2Form_SRIEFData = reactive({
  orgCd: '01234', orgNm: '特金製造課', orgAbbr: '特金製造', orgNm: '特金製造', orgRequestCd: '01234', pcCd: '', attribute: '販売店', proDpCd: '', regularRank: '', resscutFlag: '', shipflag: 'する', status: '有効', shipDay: [],
});
...
const viy2Select_ZQzdrOpts = reactive([
  {
    label:
'月曜日',
    value:
...
const asideGridAutonomousCdEditRender = computed(() => {
  return {
    enabled: false,
  };
});
  ...
  <VueForm ref="form" v-loading="lockScreen" :model="formData">
    ...
    >
      <VueForm
        ...
        :model="queryFormData"
      >
        <VuePanel id="viy2Panel_GxHSA" ref="viy2Panel_GxHSA" title="検索条件">
          <template #header>
      ...
      <VueFlex
        ...
        grow="1"
      >
        <VuePanel id="viy2Panel_GxIim" ref="viy2Panel_GxIim" title="明細情報" height="100%">
          <template #header>
            <div style="width: auto">
              <VueButton id="viy2Button_ZvPFV" ref="viy2Button_ZvPFV" icon-position="left" @click="viy2Button_ZvPFVClick">
                追加内部課
              </VueButton>
            </div>
          </template>
    ...
    >
        ...
        >
          ...
          >
            ...
            <VueCol
              ...
              :md="{ span: 12 }"
            >
              <VueButton id="viy2Button_ZKCsn" ref="viy2Button_ZKCsn" icon-position="left" type="danger">
                削除
              </VueButton>
        ...
        >
          ...
          >
            ...
            >
              <VueSelect
                id="viy2Select_ZQzdr"
                ref="viy2Select_ZQzdr"
                v-model="viy2Form_SRIEFData.shipDay"
                :style="{ width: '200px' }"
                :multiple="true"
                :options="viy2Select_ZQzdrOpts"
              />
            </VueFormItem>
          </VueCol>
          <VueCol
      ...
      <VuePanel id="viy2Panel_SXD4P" ref="viy2Panel_SXD4P" title="出荷先情報" :collapse="true" collapse-icon-position="left">
        ...
        <VueTable id="asideGrid" ref="asideGrid" :data="asideGridDs" :edit-config="asideGridEditConfig" :mouse-config="asideGridMouseConfig">
          ...
          />
          <VueInputColumn
            :edit-render="asideGridAutonomousCdEditRender"
            field="autonomousCd"
            title="自治体コード"
            width="100px"
            header-align="center"
