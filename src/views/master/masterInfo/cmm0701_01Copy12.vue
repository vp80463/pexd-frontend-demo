...
const viy2Form_SRIEFData = reactive({
  orgCd: '01234', orgNm: '特金製造株式会社', orgAbbr: '特金製造', orgNm: '特金製造', orgRequestCd: '01234', pcCd: '', attribute: '販売店', proDpCd: '', salesMan: '', resscutFlag: '', regularRank: '', status: '有効', shipflag: '可', shipDay: '火曜日',
});
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <VueInput
                id="viy2InputBox_STKLR9"
                ref="viy2InputBox_STKLR9"
                v-model="viy2Form_SRIEFData.salesMan"
                :readonly="true"
                class="no-border"
                :style="{ width: '200px' }"
              />
